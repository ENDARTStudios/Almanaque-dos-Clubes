  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-md w-full max-w-md border border-border/50">
        <h1 className="text-3xl font-heading font-bold mb-2 text-center text-foreground">Entrar</h1>
        <p className="text-center text-foreground/60 mb-8 text-sm">Acesse sua conta do Almanaque dos Clubes</p>
        ...
        <p className="text-sm text-center mt-4 text-foreground/60">
          <a href="/auth/register" className="text-primary hover:underline cursor-pointer">Criar conta</a>
        </p>
      </form>
    </div>
  );
