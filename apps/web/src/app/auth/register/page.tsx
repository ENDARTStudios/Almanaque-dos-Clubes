  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4 py-10">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-md w-full max-w-md border border-border/50">
        <h1 className="text-3xl font-heading font-bold mb-2 text-center text-foreground">{t('auth.registerTitle')}</h1>
        ...
        <div className="space-y-3 mb-6">
          <label className="flex items-start gap-2.5 text-sm text-foreground/70 cursor-pointer">
            ...
            <span>
              {t('auth.acceptTerms')}{' '}
              <Link href="/termos" className="text-primary hover:underline">{t('footer.terms')}</Link>
            </span>
          </label>
          <label className="flex items-start gap-2.5 text-sm text-foreground/70 cursor-pointer">
            ...
            <span>
              ...
              <Link href="/privacidade" className="text-primary hover:underline">{t('footer.privacy')}</Link>
            </span>
          </label>
        </div>
