...
notFoundDesc: 'The content you are looking for does not exist or has been moved.',
  ...
  pages: {
    ...
    planos: {
      title: 'Plans',
      intro: 'Almanaque dos Clubes offers one free tier and two paid subscriptions. For visitors in Brazil, prices are shown in reais ({free}, {proMonthly}, {eliteMonthly}). The total price, features, limits, period and next charge will be presented before payment confirmation. Last updated: September 2, 2026.',
      sections: [
        { title: "Free", body: ["{free} — initial access and use of the available free features. No automatic conversion to a paid plan."] },
        { title: "Pro", body: ["{proMonthly}/month or {proMonthly} annual with 15% off (12 × monthly). Expanded search and analysis, with AI features and citations when indicated at checkout. Payment via Stripe, only after express confirmation."] },
        { title: "Elite", body: ["{eliteMonthly}/month or {eliteMonthly} annual with 15% off (12 × monthly). Advanced limits and features indicated at checkout, including API or export when expressly included."] },
        { title: "Features and limits", body: ["All features and limits effectively included will be described in a comparison table at checkout and in the account panel (queries, AI credits, API calls, exports, storage, support and fair-use limits).","The absence of a feature or limit in the table means it is not automatically included. END ART will not advertise \"unlimited access\" or \"API included\" without defining scope, technical restrictions and the fair-use policy."] },
        { title: "Transparent contracting", body: ["Contracting is processed after the consumer's express confirmation. Before payment, it will be possible to review plan, period, total price, discount, automatic renewal, payment method, limits, cancellation, refund and these Terms of Use.","The Free plan does not automatically become paid. Pro and Elite renew only when this condition has been informed and accepted at checkout. The consumer may cancel through the same channels used to contract or via endart.studios@gmail.com."] },
        { title: "Cancellation and withdrawal", body: ["Cancellation stops future charges. Unless a more favorable condition applies, paid features remain until the end of the already paid period. For off-premises contracting, the consumer may exercise the legal 7-day withdrawal right (article 49 of the CDC), through the panel or endart.studios@gmail.com.","Refund will be requested through the payment method used, with confirmation to the consumer. END ART will not replace legal restitution with credit without the consumer's consent."] },
        { title: "Payment", body: ["Payment may be processed by Stripe or the provider identified at checkout. END ART does not request the card password and, when not necessary, does not store full card data."] },
        { title: "Artificial intelligence and sources", body: ["AI features are aids. They may generate incorrect, incomplete or outdated responses. Verify sources and dates before publishing or making decisions. Do not insert passwords, banking data, health data, children's data or trade secrets in prompts."] },
        { title: "Service and identification", body: ["Questions about plans, cancellation, billing, refund or features: endart.studios@gmail.com.","END ART Studios — CNPJ nº 45.370.930/0001-75 — Osasco, São Paulo, Brazil."] }
      ],
  ...
  legal: {
    ...
    terms: {
      ...
      intro: 'These Terms of Use and Service ("Terms") govern access to and use of the Almanaque dos Clubes Platform, operated by END ART Studios, CNPJ nº 45.370.930/0001-75 ("END ART"). By creating an account, contracting a plan or using the Platform, the user declares they have read and accepted these Terms. Last updated: September 2, 2026 · Version 2.0.',
      sections: [
        { title: "Provider identification", body: ["END ART Studios — trade name: END ART Studios — CNPJ nº 45.370.930/0001-75 — Osasco, São Paulo, Brazil — contact: endart.studios@gmail.com."] },
        { title: "Terms of Use and Service (\"Terms\")", body: ["These Terms govern access to and use of the website, application, search tools, historical data, rankings, API, AI-assisted features and the Free, Pro and Elite plans of Almanaque dos Clubes (\"Platform\").","Contracting and use are also subject to the Privacy Policy, Cookie Policy and Security Policy. In case of conflict between these Terms and a mandatory consumer-protection or data-protection rule, the mandatory rule prevails."] },
        { title: "1. Separate acceptance and prior information", body: ["The user will have access to these Terms before creating an account or contracting a plan. Contractual acceptance is a separate mechanism from any consent for marketing, optional cookies or other purposes not necessary to provide the service.","By checking \"I accept the Terms of Use\", creating an account or contracting a plan, the user confirms they had the opportunity to read the document. The Platform will record the version, date and time of acceptance. Lack of consent for marketing or optional cookies does not prevent sign-up or contracting."] },
        { title: "2. Identification and object", body: ["The Platform is operated by END ART Studios, CNPJ nº 45.370.930/0001-75, trade name END ART Studios, in Osasco, São Paulo, Brazil, contact endart.studios@gmail.com.","Almanaque dos Clubes gathers and organizes historical information about clubs, players, competitions, matches and rankings, with search tools and AI-assisted features. The Platform may use public sources, licensed databases, authorized contributions and internal review processes.","Almanaque is not an official body of any federation, club, league, athlete or competition, unless expressly and documented. The presence of a name, crest, mark, image or record does not imply sponsorship, endorsement, affiliation or third-party authorization."] },
        { title: "3. Account and sign-up", body: ["To create an account, the user must provide true, current and necessary information, keep their email updated and protect their password. Passwords must be stored by the Platform in protected form, never in clear text.","The user must not share credentials, create an account for another person without authorization, bypass controls, access third-party data, or allow their account to be used for fraud, intrusion, abusive extraction or rights violation.","The Platform may request proportional identity confirmation for security, refund, sensitive change or exercise of rights. Passwords will never be requested by email."] },
        { title: "4. Plans, price and offer characteristics", body: ["The Platform offers the Free plan and the paid Pro and Elite plans. In Brazil: Free R$ 0.00; Pro R$ 4.90/month or R$ 49.98/year (15% off 12 monthly payments); Elite R$ 9.90/month or R$ 100.98/year (15% off).","Annual values correspond to 12 × the monthly price with a 15% discount, rounded to cents. The checkout will show, before confirmation, the total price of the period, billing period, discount, any applicable taxes, payment method, next charge date and relevant limitations.","The Free plan allows use of the free features identified on the Platform, with no automatic conversion to a paid plan. Pro and Elite allow the paid features described at checkout, including, when indicated, expanded search, AI-assisted features with citations, technical limits and, for Elite, API or export when expressly included.","END ART will not assume that API, export, unlimited AI credits, unrestricted access or priority support are included unless expressly described in the summary. The current limits of queries, credits, requests, exports, storage and rate limits will be shown before payment and in the subscriber panel."] },
        { title: "5. Checkout, contracting and renewal", body: ["Before finalizing payment, the consumer will see a summary with: provider, plan, features, limits, price, discount, total price, taxes, period, automatic renewal, payment method, next charge date, cancellation rules, withdrawal right and links to these Terms and the Privacy Policy.","The consumer may correct data, plan or payment method before confirmation. Contracting only completes after express confirmation of the payment button. END ART will send confirmation and a storable electronic copy of the contract.","The monthly or annual subscription renews automatically only if prominently informed before payment. There is no conversion from Free to a paid plan without new express contracting. No price increase, substantial feature reduction or period change will apply without clear prior notice and, when required, new acceptance."] },
        { title: "6. Payment and charge failure", body: ["Payments may be processed by Stripe or another provider indicated at checkout. END ART does not request or store the card password and, when not necessary, does not store full card data.","In case of charge failure, END ART may inform the issue, allow payment-method update and temporarily limit paid features after reasonable notice. No hidden, duplicate or different charges from the confirmed price will be made."] },
        { title: "7. Cancellation", body: ["The consumer may cancel renewal through the account panel or the same channel used to contract, or via endart.studios@gmail.com, without justification.","Cancelling renewal stops future charges. Unless immediate termination is requested by the consumer or required due to proven violation, access to paid features remains until the end of the already paid period. Cancellation does not eliminate refund or withdrawal rights.","Account deletion and data removal follow the Privacy Policy. Records required for refund, accounting, security, fraud prevention, legal obligation or defense may be kept restricted for the necessary period."] },
        { title: "8. Withdrawal right and refund", body: ["For off-premises contracting, the consumer may exercise the withdrawal right within 7 days from signing or receiving the service, under article 49 of the Brazilian Consumer Protection Code (CDC).","The request may be made through the panel, the cancellation flow, or endart.studios@gmail.com. END ART will provide confirmation and protocol, stop renewal and request restitution through the payment method used. The consumer will not be required to accept credit when the law requires restitution.","Use of the service will not, in isolation, be used to automatically deny the legal withdrawal right. Fraud, chargeback or third-party use disputes will be investigated separately."] },
        { title: "9. Content, sources and accuracy", body: ["Historical information may contain gaps, source divergences, later changes, transcription errors or unreviewed data. The expression \"verified sources\" means the Platform seeks to identify and review sources, not that every record is infallible or officially recognized.","The update date, source and methodology, when available, should be consulted on the record or ranking page. The user may report inaccuracies to endart.studios@gmail.com."] },
        { title: "10. AI use guidelines", body: ["AI features are research and organization aids. Responses may be incorrect, incomplete, outdated, ambiguous or have inadequate citations. The user must verify sources, dates and context before publishing, sharing or making a decision based on an output.","It is prohibited to use the AI or the Platform to: generate or spread malware, phishing or intrusion instructions; commit fraud, threats, harassment, defamation or unlawful discrimination; produce forgeries or impersonations; insert or exploit third-party personal data without authorization; violate copyright, trademarks, image or trade secrets; manipulate rankings or historical information; bypass filters, rate limits or controls; reverse-engineer; copy or extract the database at scale; train or feed a competing model with Platform data; or make high-impact decisions without adequate human review.","The user must not insert passwords, banking data, health data, children's data, identity documents, trade secrets or unnecessary confidential information in prompts. The handling of prompts, responses, metadata and logs is described in the Privacy Policy.","END ART may apply filters, limit requests, revoke API keys, suspend or terminate access proportionally when there is reasonable indication of abuse, security risk or violation. When possible, it will inform the reason, preserve minimal evidence and provide a contest channel."] },
        { title: "11. Intellectual property", body: ["END ART or its licensors hold applicable rights over the brand, visual identity, software, code, layout, architecture, API, documentation, taxonomies, data models, indexes, scripts, pipelines, methodologies, original editorial texts, own images, proprietary prompts, selection, organization, normalization, curation and creative arrangement of the collection.","Historical facts, names, dates, results, statistics, public records, trademarks, crests, photographs, videos and third-party materials do not become END ART exclusive property merely by being displayed, aggregated or organized on the Platform. These materials remain subject to the rights and licenses of their respective owners.","During the plan term, END ART grants the user a limited, personal, non-exclusive, non-transferable license without sublicensing right to access and use the Platform per the contracted plan. This license does not transfer ownership nor authorize substantially copying, extracting, mirroring, reselling, redistributing at scale, publishing in a competing database, removing notices, bypassing limits or abusive scraping.","The user retains rights over content they submit, when they have them, and grants END ART only the technical license necessary to host, process, display to the user, execute the requested feature, maintain security, support, backup and comply with legal obligations.","AI outputs may be non-exclusive, may contain non-protectable or third-party elements and may require review. To the extent permitted by law, the user may use a legitimate output for a purpose compatible with the plan."] },
        { title: "12. API and extraction", body: ["When the API is included in the plan, access is limited to the documentation, individual key, limits and checkout purposes. It is prohibited to share keys, bypass rate limits, extract the database integrally or substantially, build a mirror, resell responses, redistribute at scale or create a competing service without written authorization.","END ART may block anomalous requests to protect availability and data. The measure will be proportional and may be contested at endart.studios@gmail.com."] },
        { title: "13. Security, suspension and termination", body: ["END ART adopts controls proportional to risk, including credential protection, access control, secret management, TLS where applicable, logs, backups, updates, monitoring and rate limiting. No internet-connected service is absolutely invulnerable.","In case of violation, fraud, security risk or abusive use, END ART may warn, limit function, revoke a key, temporarily suspend or terminate an account, according to severity and urgency. When possible, it will communicate the reason and offer contestation. Emergency measures may be applied immediately to prevent serious harm.","When termination occurs due to END ART decision without consumer fault during a paid period, a proportional solution will be evaluated, such as correction, equivalent resource, abatement or due refund."] },
        { title: "14. Liability", body: ["END ART will respond per the Consumer Protection Code, LGPD and applicable laws for damages and failures attributable to it. Nothing in these Terms excludes non-waivable legal liability, service defect, undue charge, data breach or basic consumer rights.","END ART does not guarantee continuous availability, absolute absence of error or instant update of the entire collection. This limitation does not authorize breach of the offer, denial of legal rights or prevention of correction, support or repair where due.","The user may be responsible for demonstrably caused damages by unlawful use, unauthorized content insertion, fraud, abusive extraction or third-party rights violations."] },
        { title: "15. Changes", body: ["Non-material changes may be incorporated with indication of the update date. Material changes will be communicated before taking effect, with a clear summary and new acceptance when necessary. Continued use will not, in isolation, be used to impose a material change to an adhesion contract without adequate communication."] },
        { title: "16. Communications and contact", body: ["Service, cancellation, refund, content correction, privacy and contractual questions: endart.studios@gmail.com. For security, the dedicated channel indicated in the Security Policy is recommended when available."] },
        { title: "17. Governing law and jurisdiction", body: ["Brazilian law applies. In consumer relations, the forum of the consumer's domicile and any other forum recognized by law as competent or more favorable is preserved. The indication of Osasco, São Paulo does not prevent the consumer from using their legal forum, consumer protection bodies or the Judiciary."] },
        { title: "References", body: ["[1] CDC — Law nº 8.078/1990 · [2] Decree nº 7.962/2013 (e-commerce) · [3] LGPD — Law nº 13.709/2018 · [4] Law nº 9.610/1998 (Copyright) · [5] GDPR — Regulation (EU) 2016/679, where applicable."] }
      ],
    },
    privacy: {
