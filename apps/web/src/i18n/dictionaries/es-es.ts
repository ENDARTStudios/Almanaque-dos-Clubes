...
const es: Dictionary = {
  ...
  footer: {
    tagline:
      'La historia del fútbol, en construcción y con fuentes verificadas. Clubes, jugadores, competiciones y rankings auditables (metodología en /metodologia).',
  ...
  pages: {
    ...
    rankings: {
      ...
      pilotBadge: 'Piloto Inglaterra · Fuente RSSSF',
      pilotSubtitle:
        'Basado en las tablas finales de clasificación de las ligas inglesas (RSSSF). Sin títulos en esta fase.',
      pilotMethodology: 'Ver metodología',
      filterYear: 'Año',
      filterGender: 'Género',
      filterCountry: 'País',
      all: 'Todos',
    ...
    cookiePolicy: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            'Proveedores actuales: Vercel (frontend), Railway (API y base PostgreSQL) y Cloudflare (DNS/red); pagos vía Stripe. Los proveedores de alojamiento, autenticación, pago, analítica, soporte, IA y seguridad pueden recibir identificadores según la finalidad, siempre minimizados y vinculados contractualmente. Cuando haya transferencia internacional, deben observarse la LGPD y (si aplica) el GDPR.',
          ],
        },
        {
  ...
  checkout: {
    title: 'Checkout',
    intro:
      'Elige el plan y la periodicidad. El precio total, la moneda y la forma de pago se muestran antes de la confirmación. Suscripción con renovación automática hasta la cancelación; arrepentimiento en hasta 7 días (CDC art. 49).',
    beforeTitle: 'Antes de suscribirte, tienes:',
    compare: 'Comparativa completa de los planes',
    compareSuffix: 'con recursos y límites',
    terms: 'Términos de Uso',
    privacy: 'Política de Privacidad',
    termsMid: 'vigentes (versión registrada) y',
    cancelInfo: 'Cancelación de la renovación en 1 clic en el panel de la suscripción',
    withdrawInfo: 'Arrepentimiento en 7 días:',
    includedTitle: 'Recursos incluidos (por plan)',
    paymentsSoon: 'Pagos muy pronto.',
  },
};
