...
notFoundDesc: 'El contenido que buscas no existe o ha sido movido.',
  ...
  pages: {
    ...
    planos: {
      title: 'Planes',
      intro: 'Almanaque dos Clubes ofrece una modalidad gratuita y dos suscripciones de pago. Para visitantes en Brasil, los precios se muestran en reales ({free}, {proMonthly}, {eliteMonthly}). El precio total, las funciones, los límites, la periodicidad y el próximo cobro se presentarán antes de la confirmación del pago. Última actualización: 2 de septiembre de 2026.',
      sections: [
        { title: "Free", body: ["{free} — consulta inicial y uso de los recursos gratuitos disponibles. Sin conversión automática a plan de pago."] },
        { title: "Pro", body: ["{proMonthly}/mes o {proMonthly} anual con 15% de descuento (12 × mensual). Búsqueda y análisis ampliados, con funciones de IA y citas cuando se indiquen en el checkout. Pago vía Stripe, solo tras confirmación expresa."] },
        { title: "Elite", body: ["{eliteMonthly}/mes o {eliteMonthly} anual con 15% de descuento (12 × mensual). Límites y funciones avanzadas indicados en el checkout, incluida API o exportación cuando se incluya expresamente."] },
        { title: "Funciones y límites", body: ["Todas las funciones y límites incluidos se describirán en una tabla comparativa en el checkout y en el panel de la cuenta (consultas, créditos de IA, llamadas de API, exportaciones, almacenamiento, soporte y límites de uso justo).","La ausencia de una función o límite en la tabla significa que no está incluida automáticamente. END ART no anunciará \"acceso ilimitado\" o \"API incluida\" sin definir el alcance, las restricciones técnicas y la política de uso justo."] },
        { title: "Contratación transparente", body: ["La contratación se procesa tras la confirmación expresa del consumidor. Antes del pago, será posible revisar plan, periodicidad, precio total, descuento, renovación automática, método de pago, límites, cancelación, reembolso y estos Términos de Uso.","El plan Free no se convierte automáticamente en plan de pago. Los planes Pro y Elite se renuevan solo si esa condición se ha informado y aceptado en el checkout. El consumidor puede cancelar por los mismos canales usados para contratar o por endart.studios@gmail.com."] },
        { title: "Cancelación y arrepentimiento", body: ["La cancelación detiene cobros futuros. Salvo condición más favorable, las funciones de pago permanecen hasta el final del periodo ya pagado. En contratación fuera del establecimiento comercial, el consumidor puede ejercer el derecho de arrepentimiento en el plazo legal de 7 días (art. 49 del CDC), por el panel o endart.studios@gmail.com.","El reembolso se solicitará por el medio de pago utilizado, con confirmación al consumidor. END ART no reemplazará la restitución legal por crédito sin el consentimiento del consumidor."] },
        { title: "Pago", body: ["El pago puede procesarse por Stripe o el proveedor identificado en el checkout. END ART no solicita la contraseña de la tarjeta y, cuando no sea necesario, no almacena datos completos de la tarjeta."] },
        { title: "Inteligencia artificial y fuentes", body: ["Las funciones de IA son auxiliares. Pueden generar respuestas incorrectas, incompletas o desactualizadas. Verifica fuentes y fechas antes de publicar o tomar decisiones. No insertes contraseñas, datos bancarios, datos de salud, datos de menores o secretos comerciales en los prompts."] },
        { title: "Atención e identificación", body: ["Dudas sobre planes, cancelación, cobro, reembolso o funciones: endart.studios@gmail.com.","END ART Studios — CNPJ nº 45.370.930/0001-75 — Osasco, São Paulo, Brasil."] }
      ],
    ...
    ia: {
      ...
      intro: 'Almanaque dos Clubes usa inteligencia artificial como herramienta auxiliar de investigación, síntesis, clasificación y presentación de información. Esta página explica su funcionamiento, limitaciones, directrices de uso y tus derechos. Las respuestas asistidas por IA no son una fuente oficial y no sustituyen la verificación humana.',
      sections: [
        { title: "Función y limitaciones", body: ["Las funciones de IA de Almanaque dos Clubes son auxiliares de investigación, síntesis, clasificación y navegación del acervo. Las respuestas pueden ser incorrectas, incompletas, desactualizadas, ambiguas o con citas inadecuadas.","Aviso junto a la consulta: \"Respuesta asistida por inteligencia artificial. Puede contener errores, omisiones o información desactualizada. Comprueba las fuentes, fechas y contexto antes de usar o compartir. No insertes datos confidenciales o personales innecesarios.\"","Aviso junto a la respuesta: \"Importante: esta respuesta fue generada u organizada con ayuda de IA. No es una fuente oficial, no garantiza precisión o completitud y no sustituye la verificación humana. Consulta las fuentes indicadas y reporta una posible imprecisión a endart.studios@gmail.com.\""] },
        { title: "Uso permitido", body: ["La IA debe utilizarse para investigación histórica, localización de registros, síntesis, comparación, organización y navegación del acervo, siempre dentro de los límites del plan. El usuario debe verificar la respuesta en fuentes primarias, fuentes citadas, registros oficiales u otras fuentes independientes antes de publicar, compartir o tomar decisiones."] },
        { title: "Uso prohibido", body: ["Se prohíbe usar la IA para: generar malware, ransomware, phishing, credenciales falsas o instrucciones de intrusión; cometer fraude, falsedad, suplantación, amenazas, acoso, difamación o discriminación ilícita; insertar, inferir, exponer o explotar datos personales de terceros sin autorización; insertar contraseñas, datos de tarjeta, documentos, datos de salud, datos de menores, secretos comerciales o información confidencial innecesaria; violar derechos de autor, marcas, imagen, personalidad, confidencialidad, contratos o licencias; manipular rankings, fabricar fuentes, eliminar citas o atribuir una respuesta a END ART o a una fuente oficial sin autorización; realizar ingeniería inversa, eludir filtros, sortear rate limits, explotar vulnerabilidades o interferir en la disponibilidad; extraer en masa o usar la base, respuestas o API para construir, entrenar o alimentar un producto competidor; tomar decisiones de alto impacto sobre personas sin revisión humana, explicación, base legal y salvaguardas adecuadas; o usar salidas como asesoramiento jurídico, médico, financiero o como única base para decisiones de contratación, inversión, reputación o seguridad."] },
        { title: "Fuentes, citas y datos enviados a proveedores", body: ["Cuando haya una cita, mostrar la fuente y la fecha de consulta o actualización cuando esté técnicamente disponible. No presentar una cita fabricada como fuente verificable.","END ART mantiene una lista actualizada de los proveedores de IA, sus funciones, países, subprocesadores, retención, medidas de seguridad y uso o no para entrenamiento. La Política de Privacidad informa qué prompts, contexto, metadatos, comentarios y respuestas pueden enviarse. END ART no usará contenido identificable del usuario para entrenamiento fuera de la finalidad informada, salvo base legal adecuada."] },
        { title: "Filtros e impugnación", body: ["El usuario no debe insertar contraseñas, datos bancarios, datos de salud, datos de menores, documentos de identidad, secretos comerciales ni información confidencial innecesaria en los prompts.","Ante abuso, riesgo de seguridad o violación, END ART puede bloquear una consulta, reducir límites, suspender temporalmente, revocar API o finalizar una cuenta de forma proporcional. Cuando sea posible, comunicará el motivo y ofrecerá impugnación en endart.studios@gmail.com. Las medidas urgentes pueden ocurrir sin aviso previo cuando sea necesario para evitar daño grave."] }
      ],
    },
    termosAssinatura: {
  ...
  legal: {
    ...
    terms: {
      ...
      intro: 'Estos Términos de Uso y Servicio ("Términos") regulan el acceso y uso de la Plataforma Almanaque dos Clubes, operada por END ART Studios, CNPJ nº 45.370.930/0001-75 ("END ART"). Al crear una cuenta, contratar un plan o usar la Plataforma, el usuario declara haber leído y aceptado estos Términos. Última actualización: 2 de septiembre de 2026 · Versión 2.0.',
      sections: [
        { title: "Identificación del proveedor", body: ["END ART Studios — Nombre Comercial: END ART Studios — CNPJ nº 45.370.930/0001-75 — Osasco, São Paulo, Brasil — contacto: endart.studios@gmail.com."] },
        { title: "Términos de Uso y Servicio (\"Términos\")", body: ["Estos Términos regulan el acceso y uso del sitio, la aplicación, las herramientas de búsqueda, los datos históricos, los rankings, la API, las funciones asistidas por inteligencia artificial y los planes Free, Pro y Elite de Almanaque dos Clubes (\"Plataforma\").","La contratación y el uso de la Plataforma también están sujetos a la Política de Privacidad, la Política de Cookies y la Política de Seguridad. En caso de conflicto entre estos Términos y una norma obligatoria de protección del consumidor o de datos, prevalece la norma obligatoria."] },
        { title: "1. Aceptación separada e información previa", body: ["El usuario tendrá acceso a estos Términos antes de crear una cuenta o contratar un plan. La aceptación contractual es un mecanismo separado de cualquier consentimiento para marketing, cookies opcionales u otras finalidades no necesarias para prestar el servicio.","Al marcar \"He leído y acepto los Términos de Uso\", crear una cuenta o contratar un plan, el usuario confirma que tuvo la oportunidad de leer el documento. La Plataforma registrará la versión, fecha y hora de la aceptación. La falta de consentimiento para marketing u cookies opcionales no impide el registro ni la contratación."] },
        { title: "2. Identificación y objeto", body: ["La Plataforma es operada por END ART Studios, CNPJ nº 45.370.930/0001-75, Nombre Comercial END ART Studios, en Osasco, São Paulo, Brasil, contacto endart.studios@gmail.com.","Almanaque dos Clubes reúne y organiza información histórica sobre clubes, jugadores, competiciones, partidos y rankings, con herramientas de búsqueda y funciones asistidas por IA. La Plataforma puede usar fuentes públicas, bases licenciadas, contribuciones autorizadas y procesos internos de revisión.","Almanaque no es un organismo oficial de federación, club, liga, atleta o competición, salvo indicación expresa y documentada. La presencia de nombre, escudo, marca, imagen o registro no implica patrocinio, respaldo, afiliación ni autorización de terceros."] },
        { title: "3. Registro y cuenta", body: ["Para crear una cuenta, el usuario debe proporcionar información verdadera, actual y necesaria, mantener su correo actualizado y proteger su contraseña. Las contraseñas deben almacenarse de forma protegida, nunca en texto claro.","El usuario no debe compartir credenciales, crear una cuenta para otra persona sin autorización, eludir controles, acceder a datos de terceros ni permitir que su cuenta se use para fraude, intrusión, extracción abusiva o violación de derechos.","La Plataforma puede solicitar confirmación proporcional de identidad por seguridad, reembolso, cambio sensible o ejercicio de derechos. Nunca se solicitará la contraseña por correo."] },
        { title: "4. Planes, precio y características de la oferta", body: ["La Plataforma ofrece el plan Free y los planes de pago Pro y Elite. En Brasil: Free R$ 0,00; Pro R$ 4,90/mes o R$ 49,98/año (15% de descuento sobre 12 mensualidades); Elite R$ 9,90/mes o R$ 100,98/año (15% de descuento).","Los valores anuales corresponden a 12 × el precio mensual con un 15% de descuento, redondeado a céntimos. El checkout mostrará, antes de la confirmación, el precio total del periodo, la periodicidad, el descuento, impuestos aplicables, forma de pago, fecha de la siguiente cobro y limitaciones relevantes.","El plan Free permite usar los recursos gratuitos identificados en la Plataforma, sin conversión automática a plan de pago. Pro y Elite permiten los recursos de pago descritos en el checkout, incluyendo, cuando se indique, búsqueda ampliada, IA asistida con citaciones, límites técnicos y, para Elite, API o exportación cuando se incluya expresamente.","END ART no asumirá que API, exportación, créditos ilimitados de IA, acceso irrestricto o soporte prioritario están incluidos si no se describen expresamente en el resumen. Los límites vigentes de consultas, créditos, solicitudes, exportaciones, almacenamiento y rate limit se mostrarán antes del pago y en el panel del suscriptor."] },
        { title: "5. Checkout, contratación y renovación", body: ["Antes de finalizar el pago, el consumidor verá un resumen con: proveedor, plan, funciones, límites, precio, descuento, precio total, impuestos, periodicidad, renovación automática, medio de pago, fecha del siguiente cobro, reglas de cancelación, derecho de arrepentimiento y enlaces a estos Términos y la Política de Privacidad.","El consumidor puede corregir datos, plan o forma de pago antes de la confirmación. La contratación solo se completa tras la confirmación expresa del botón de pago. END ART enviará confirmación y una copia electrónica conservable del contrato.","La suscripción mensual o anual se renueva automáticamente solo si se informa de forma destacada antes del pago. No hay conversión de Free a plan de pago sin nueva contratación expresa. Ningún aumento de precio, reducción sustancial de funciones o cambio de periodicidad se aplicará sin aviso previo claro y, cuando sea necesario, nueva aceptación."] },
        { title: "6. Pago y fallo de cobro", body: ["Los pagos pueden procesarse por Stripe u otro proveedor indicado en el checkout. END ART no solicita ni almacena la contraseña de la tarjeta y, cuando no sea necesario, no almacena datos completos de la tarjeta.","En caso de fallo de cobro, END ART puede informar el problema, permitir la actualización del medio de pago y limitar temporalmente funciones de pago tras aviso razonable. No se realizarán cobros ocultos, duplicados ni diferentes al precio confirmado."] },
        { title: "7. Cancelación", body: ["El consumidor puede cancelar la renovación desde el panel de la cuenta o el mismo canal usado para contratar, o por endart.studios@gmail.com, sin justificación.","Cancelar la renovación detiene cobros futuros. Salvo cese inmediato solicitado por el consumidor o medida necesaria por violación comprobada, el acceso a funciones de pago permanece hasta el final del periodo ya pagado. La cancelación no elimina derechos de reembolso o arrepentimiento.","La eliminación de la cuenta y de datos sigue la Política de Privacidad. Los registros necesarios para reembolso, contabilidad, seguridad, prevención de fraude, obligación legal o defensa pueden conservarse de forma restringida por el plazo necesario."] },
        { title: "8. Derecho de arrepentimiento y reembolso", body: ["En contrataciones fuera del establecimiento comercial, el consumidor puede ejercer el derecho de arrepentimiento en el plazo de 7 días desde la firma o recepción del servicio, conforme al art. 49 del Código de Defensa del Consumidor.","La solicitud puede realizarse por el panel, el flujo de cancelación o endart.studios@gmail.com. END ART proporcionará confirmación y protocolo, detendrá la renovación y solicitará la restitución por el medio de pago utilizado. El consumidor no estará obligado a aceptar crédito cuando la ley exija restitución.","El uso del servicio no se utilizará aisladamente para negar automáticamente el derecho legal de arrepentimiento. Las disputas de fraude, chargeback o uso por terceros se investigarán por separado."] },
        { title: "9. Contenido, fuentes y precisión", body: ["La información histórica puede contener lagunas, divergencias entre fuentes, cambios posteriores, errores de transcripción o datos aún no revisados. La expresión \"fuentes verificadas\" significa que la Plataforma busca identificar y revisar fuentes, no que todo registro sea infalible u oficialmente reconocido.","La fecha de actualización, la fuente y la metodología, cuando estén disponibles, deben consultarse en la página del registro o ranking. El usuario puede reportar imprecisiones a endart.studios@gmail.com."] },
        { title: "10. Directrices de uso de la IA", body: ["Las funciones de IA son auxiliares de investigación y organización. Las respuestas pueden ser incorrectas, incompletas, desactualizadas, ambiguas o con citas inadecuadas. El usuario debe verificar fuentes, fechas y contexto antes de publicar, compartir o tomar decisiones.","Se prohíbe usar la IA o la Plataforma para: generar o difundir malware, phishing o instrucciones de intrusión; cometer fraude, amenazas, acoso, difamación o discriminación ilícita; producir falsificaciones o suplantaciones; insertar o explotar datos personales de terceros sin autorización; violar derechos de autor, marcas, imagen o secretos comerciales; manipular rankings o información histórica; eludir filtros, rate limits o controles; realizar ingeniería inversa; copiar o extraer la base a escala; entrenar o alimentar un modelo competidor con datos de la Plataforma; o tomar decisiones de alto impacto sin revisión humana adecuada.","El usuario no debe insertar contraseñas, datos bancarios, datos de salud, datos de menores, documentos de identidad, secretos comerciales ni información confidencial innecesaria en los prompts. El tratamiento de prompts, respuestas, metadatos y logs se describe en la Política de Privacidad.","END ART puede aplicar filtros, limitar solicitudes, revocar claves de API, suspender o finalizar el acceso de forma proporcional cuando haya indicio razonable de abuso, riesgo de seguridad o violación. Cuando sea posible, informará el motivo, preservará evidencia mínima y ofrecerá un canal de impugnación."] },
        { title: "11. Propiedad intelectual", body: ["END ART o sus licenciantes poseen los derechos aplicables sobre la marca, identidad visual, software, código, diseño, arquitectura, API, documentación, taxonomías, modelos de datos, índices, scripts, pipelines, metodologías, textos editoriales originales, imágenes propias, prompts propietarios, selección, organización, normalización, curación y disposición creativa del acervo.","Los hechos históricos, nombres, fechas, resultados, estadísticas, registros públicos, marcas, escudos, fotografías, vídeos y materiales de terceros no se convierten en propiedad exclusiva de END ART solo por mostrarse, agregarse u organizarse en la Plataforma. Estos materiales siguen sujetos a los derechos y licencias de sus titulares.","Durante la vigencia del plan, END ART otorga al usuario una licencia limitada, personal, no exclusiva, no transferible y sin derecho de sublicencia para acceder y usar la Plataforma según el plan contratado. Esta licencia no transfiere propiedad ni autoriza copiar sustancialmente, extraer, reflejar, revender, redistribuir a escala, publicar en una base competidora, eliminar avisos, eludir límites o hacer scraping abusivo.","El usuario conserva los derechos sobre el contenido que envíe, cuando los tenga, y otorga a END ART solo la licencia técnica necesaria para alojar, procesar, mostrar al usuario, ejecutar la función solicitada, mantener seguridad, soporte, respaldo y cumplir obligaciones legales.","Las salidas de IA pueden no ser exclusivas, pueden contener elementos no protegibles o de terceros y pueden requerir revisión. En la medida permitida por la ley, el usuario puede usar una salida legítima para una finalidad compatible con el plan."] },
        { title: "12. API y extracción", body: ["Cuando la API esté incluida en el plan, el acceso se limita a la documentación, clave individual, límites y finalidades del checkout. Se prohíbe compartir claves, eludir rate limits, extraer la base íntegra o sustancialmente, crear un espejo, revender respuestas, redistribuir a escala o crear un servicio competidor sin autorización escrita.","END ART puede bloquear solicitudes anómalas para proteger la disponibilidad y los datos. La medida será proporcional y podrá impugnarse en endart.studios@gmail.com."] },
        { title: "13. Seguridad, suspensión y cese", body: ["END ART adopta controles proporcionales al riesgo, incluida protección de credenciales, control de acceso, gestión de secretos, TLS cuando aplica, logs, copias de seguridad, actualizaciones, monitoreo y rate limiting. Ningún servicio conectado a internet es absolutamente invulnerable.","Ante violación, fraude, riesgo de seguridad o uso abusivo, END ART puede advertir, limitar funciones, revocar una clave, suspender temporalmente o finalizar una cuenta, según gravedad y urgencia. Cuando sea posible, comunicará el motivo y ofrecerá impugnación. Las medidas de emergencia pueden aplicarse de inmediato para evitar daño grave.","Cuando el cese ocurra por decisión de END ART sin culpa del consumidor durante un periodo pagado, se evaluará una solución proporcional, como corrección, recurso equivalente, reducción o reembolso correspondiente."] },
        { title: "14. Responsabilidad", body: ["END ART responderá conforme al Código de Defensa del Consumidor, la LGPD y demás leyes aplicables por los daños y fallos que le sean imputables. Nada en estos Términos excluye responsabilidad legal inderogable, vicio o defecto del servicio, cobro indebido, violación de datos o derechos básicos del consumidor.","END ART no garantiza disponibilidad continua, ausencia absoluta de error ni actualización instantánea de todo el acervo. Esta limitación no autoriza el incumplimiento de la oferta, la negación de derechos legales ni impide la corrección, soporte o reparación cuando proceda.","El usuario puede responder por daños demostradamente causados por uso ilícito, inserción no autorizada de contenido, fraude, extracción abusiva o violación de derechos de terceros."] },
        { title: "15. Cambios", body: ["Los cambios no materiales pueden incorporarse indicando la fecha de actualización. Los cambios materiales se comunicarán antes de producir efectos, con un resumen claro y nueva aceptación cuando sea necesaria. El uso continuado no se utilizará aisladamente para imponer un cambio material a un contrato de adhesión sin comunicación adecuada."] },
        { title: "16. Comunicaciones y contacto", body: ["Servicio, cancelación, reembolso, corrección de contenido, privacidad y dudas contractuales: endart.studios@gmail.com. Para seguridad, se recomienda el canal dedicado indicado en la Política de Seguridad, cuando esté disponible."] },
        { title: "17. Ley aplicable y fuero", body: ["Se aplica la legislación brasileña. En relaciones de consumo, se preserva el fuero del domicilio del consumidor y cualquier otro fuero que la legislación reconozca como competente o más favorable. La indicación de Osasco, São Paulo no impide al consumidor utilizar su fuero legal, organismos de defensa del consumidor o el Poder Judicial."] },
        { title: "Referencias", body: ["[1] CDC — Ley nº 8.078/1990 · [2] Decreto nº 7.962/2013 (comercio electrónico) · [3] LGPD — Ley nº 13.709/2018 · [4] Ley nº 9.610/1998 (Derechos de Autor) · [5] GDPR — Reglamento (UE) 2016/679, cuando aplique."] }
      ],
    },
    privacy: {
