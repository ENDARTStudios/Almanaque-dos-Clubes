...
const pt: Dictionary = {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            'Histórico de versões: v1.0 (01/09/2026) — versão inicial; v1.1 (18/09/2026) — inclusão do canal de notificações de direitos autorais.',
          ],
        },
      ],
    },
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            'Histórico de versões: v1.0 (01/09/2026) — versão inicial; v1.1 (18/09/2026) — inclusão dos canais de exercício de direitos do titular e de notificações de direitos autorais.',
          ],
        },
      ],
    },
  ...
  direitosTitular: {
    ...
    successBody: 'Guarde o protocolo abaixo para acompanhar o andamento.',
    protocolLabel: 'Protocolo',
    trackNow: 'Acompanhar agora',
    trackTitle: 'Acompanhar solicitação',
    ...
    rightTypes: {
      ...
      infoCompartilhamento: 'Informação sobre com quem compartilhamos dados',
      infoConsequencia: 'Informação sobre as consequências de não fornecer dados',
      revisaoAutomatizada: 'Revisão de decisões tomadas unicamente de forma automatizada',
