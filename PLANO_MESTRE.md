...
**Nota T448b-2d seed identidades GO/PR 2025 (09-25): [x] CONCLUÍDO - identidades ativas em produção (adendum 35).** Micro-seed só-clubes por QID (`Q1513287` Vila Nova/GO, `Q2580083` Operário Ferroviário/PR) via Wikidata CC0: `lib/rsssf/seeds/club-seed.ts` + packs + script (DRY/`--apply`). Homônimos `Q10391045/Q10391046/Q671621` intocados. Testes unit 9 + integração 1. #214 (`4372cd8`) → apply prod `created=2`; clubes ativos 3878→3880; dup QID=0. **Writers GO/PR 2025 [~] implementados** (generalização retrocompatível + loader + `--pack=go-2025|pr-2025`; apply em produção pendente do gate 2.2).
